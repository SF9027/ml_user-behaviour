...
After combing the data, we finally got the dataset "userdataset2". After the above data processing, we observed that there are still unnecessary columns and we prefered to hide them. (which colunms)
